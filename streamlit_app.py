...
st.markdown(
    ...
    /* Native Streamlit header stays available so mobile users can open the sidebar. */
    header[data-testid="stHeader"],
    [data-testid="stHeader"],
    .stAppHeader {{
        background: #0B1220 !important;
    ...
    /* Desktop sidebar starts below the compact native header. */
    ...
    /* Mobile keeps Streamlit's native sidebar control usable. */
